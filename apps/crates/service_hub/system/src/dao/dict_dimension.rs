...
use entity::system::{DictDimension, dict_dimension};
...
impl DictDimensionDao {
    ...
    pub async fn all(&self) -> Result<(Vec<dict_dimension::Model>, u64), DbErr> {
        let results = DictDimension::find()
    ...
    pub async fn info(&self, id: i32) -> Result<Option<dict_dimension::Model>, DbErr> {
        DictDimension::find_by_id(id).one(self.db.db()).await
    }
    ...
    pub async fn update(&self, active_model: dict_dimension::ActiveModel) -> Result<u64, DbErr> {
        ...
        let result = DictDimension::update_many()
            .set(active_model)
    ...
    pub async fn delete(&self, id: i32) -> Result<u64, DbErr> {
        let result = DictDimension::delete_by_id(id).exec(self.db.db()).await?;
        Ok(result.rows_affected)
    }
}
