    ...
    pub fn register() -> Router {
        Router::new().nest(
            ...
            Router::new()
                ...
                .merge(user_phone::PhoneRouter::register()) // 用户手机号管理
                .merge(user_email::EmailRouter::register()) // 用户邮箱管理
                .merge(user_blockchain_wallet::BlockchainWalletRouter::register()) // 用户区块链钱包管理
