...
pub mod users_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/api.Users/GetUsers");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("api.Users", "GetUsers"));
...
pub mod users_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/api.Users/GetUsers" => {
                    ...
                    struct GetUsersSvc<T: Users>(pub Arc<T>);
                    impl<T: Users> tonic::server::UnaryService<super::GetUsersRequest>
                    for GetUsersSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Users>::get_users(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "api.Users";
